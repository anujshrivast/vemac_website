...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['form_type'] === 'add_fee') {
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO fees (student_id, student_name,  total_amount, payment_method, transaction_id, payment_date, status, remarks) 
                               VALUES (?, (SELECT CONCAT(first_name, ' ', last_name) FROM student_data WHERE student_id = ?), ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("isssdsss", $student_id, $student_id, $academic_year, $fee_type, $total_amount, $payment_method, $transaction_id, $payment_date, $status, $notes);
        
        if (!$stmt->execute()) {
            throw new Exception("Failed to add fee payment: " . $stmt->error);
        }
        
        $fee_id = $stmt->insert_id;
        $stmt->close();

        // Handle fee period details if provided
        // In the POST handler section where fee details are processed:
if (!empty($_POST['fee_from_months']) && !empty($_POST['fee_to_months']) && !empty($_POST['fee_month_amounts'])) {
    ...
    foreach ($fromMonths as $idx => $fromMonth) {
        ...
        // Validate date range (from_month should be <= to_month)
    ...
    $detailStmt->close();
        ...
        $_SESSION['success_message'] = "Fee payment added successfully.";
...
$students = [];
$stmt = $conn->prepare("SELECT student_id, first_name, last_name FROM student_data WHERE institute_name = ? ORDER BY first_name, last_name");
...
<head>
    ...
    <title>Add Fee Payment - <?= htmlspecialchars($instituteName) ?> 
    </title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-0">
                        <i class="bi bi-cash-stack me-2"></i> Fee Payment Management
                    </h1>
                    <a href="office.php?section=fees-management" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <h2 class="h5 mb-0">Add New Fee Payment</h2>
                    ...
                    <div class="card-body">
                        <!-- Fee Payment Form -->
                        <form id="feePaymentForm" action="process_fee.php" method="POST" class="needs-validation"
                            novalidate>
                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
                            <input type="hidden" name="form_type" value="add_fee">
                            ...
                            <div class="mb-4">
                                ...
                                <!-- Student Fee Summary (will be populated by JavaScript) -->
                                <div class="student-info-card mt-3" id="studentFeeInfo" style="display: none;">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h4 class="h5 mb-0" id="studentName"></h4>
                                        <span class="badge bg-primary" id="studentIdBadge"></span>
                                    </div>
                                    <div class="fee-summary">
                                        <div class="fee-summary-item paid-fee">
                                            <div class="text-muted small">Paid Fees</div>
                                            <div class="fee-amount text-success" id="paidAmount">₹0.00</div>
                                        </div>
                                        <div class="fee-summary-item pending-fee">
                                            <div class="text-muted small">Pending Fees</div>
                                            <div class="fee-amount text-warning" id="pendingAmount">₹0.00</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="total_amount"
                                                name="total_amount" step="0.01" min="0" placeholder="0.00" required>
                                        </div>
                                ...
                                <div class="mt-4" id="multiMonthSection">
                                    ...
                                    <div id="monthsContainer" class="row g-2">
                                        <!-- Dynamic month range fields will appear here -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                ...
                                <div>
                                    ...
                                    <button type="submit" class="btn btn-primary" id="submitBtn">
                                        <i class="bi bi-save me-1"></i> Save Fee Payment
                                    </button>
                                </div>
                            </div>
                        </form>
