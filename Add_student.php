...
// Function to generate admission code
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $query = "INSERT INTO student_data ($fields) VALUES ($placeholders)";
...
<head>
    ...
    <title>Add New Student - VEMAC</title>
...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <input type="hidden" name="Admission_code" value="<?= $admissionCode ?>">
                            ...
                            <div class="tab-content" id="studentFormTabsContent">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control <?= isset($_SESSION['form_errors']['first_name']) ? 'is-invalid' : '' ?>"
                                                        ...
                                                        value="<?= isset($_SESSION['old_form_data']['first_name']) ? $_SESSION['old_form_data']['first_name'] : '' ?>"
                                                        required>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control <?= isset($_SESSION['form_errors']['last_name']) ? 'is-invalid' : '' ?>"
                                                        ...
                                                        value="<?= isset($_SESSION['old_form_data']['last_name']) ? $_SESSION['old_form_data']['last_name'] : '' ?>"
                                                        required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="email" class="form-control <?= isset($_SESSION['form_errors']['email']) ? 'is-invalid' : '' ?>"
                                                        id="email" name="email"
                                                        value="<?= isset($_SESSION['old_form_data']['email']) ? $_SESSION['old_form_data']['email'] : '' ?>"
                                                        required>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="tel" class="form-control <?= isset($_SESSION['form_errors']['phone']) ? 'is-invalid' : '' ?>"
                                                        id="phone" name="phone"
                                                        value="<?= isset($_SESSION['old_form_data']['phone']) ? $_SESSION['old_form_data']['phone'] : '' ?>"
                                                        required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="date" class="form-control <?= isset($_SESSION['form_errors']['dob']) ? 'is-invalid' : '' ?>"
                                                        id="dob" name="dob"
                                                        value="<?= isset($_SESSION['old_form_data']['dob']) ? $_SESSION['old_form_data']['dob'] : '' ?>"
                                                        required>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select <?= isset($_SESSION['form_errors']['gender']) ? 'is-invalid' : '' ?>"
                                                        ...
                                                        <option value="Male" <?= (isset($_SESSION['old_form_data']['gender']) && $_SESSION['old_form_data']['gender'] == 'Male') ? 'selected' : '' ?>>Male</option>
                                                        <option value="Female" <?= (isset($_SESSION['old_form_data']['gender']) && $_SESSION['old_form_data']['gender'] == 'Female') ? 'selected' : '' ?>>Female</option>
                                                        <option value="Other" <?= (isset($_SESSION['old_form_data']['gender']) && $_SESSION['old_form_data']['gender'] == 'Other') ? 'selected' : '' ?>>Other</option>
                                                    </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select <?= isset($_SESSION['form_errors']['course']) ? 'is-invalid' : '' ?>"
                                                ...
                                                <?php foreach ($courseOptions as $value => $label): ?>
                                                    <option value="<?= $value ?>" <?= (isset($_SESSION['old_form_data']['course']) && $_SESSION['old_form_data']['course'] == $value) ? 'selected' : '' ?>>
                                                        <?= $label ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="school_type" name="school_type"
                                                value="<?= isset($_SESSION['old_form_data']['school_type']) ? $_SESSION['old_form_data']['school_type'] : '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="school" name="school"
                                                value="<?= isset($_SESSION['old_form_data']['school']) ? $_SESSION['old_form_data']['school'] : '' ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="Admission_code"
                                                    value="<?= $admissionCode ?>" readonly required>
                                                <button class="btn btn-outline-secondary" type="button" id="copyAdmissionCode">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="enrollment_date" name="enrollment_date"
                                                value="<?= isset($_SESSION['old_form_data']['enrollment_date']) ? $_SESSION['old_form_data']['enrollment_date'] : date('Y-m-d') ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="expected_graduation" name="expected_graduation"
                                                value="<?= isset($_SESSION['old_form_data']['expected_graduation']) ? $_SESSION['old_form_data']['expected_graduation'] : '' ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="contact" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control <?= isset($_SESSION['form_errors']['address']) ? 'is-invalid' : '' ?>"
                                            id="address" name="address" rows="3" required><?= isset($_SESSION['old_form_data']['address']) ? $_SESSION['old_form_data']['address'] : '' ?></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city"
                                                value="<?= isset($_SESSION['old_form_data']['city']) ? $_SESSION['old_form_data']['city'] : '' ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="state" class="form-label">State/Province</label>
                                            <input type="text" class="form-control" id="state" name="state"
                                                value="<?= isset($_SESSION['old_form_data']['state']) ? $_SESSION['old_form_data']['state'] : '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="postal_code" name="postal_code"
                                                value="<?= isset($_SESSION['old_form_data']['postal_code']) ? $_SESSION['old_form_data']['postal_code'] : '' ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="country" class="form-label">Country</label>
                                            <input type="text" class="form-control" id="country" name="country"
                                                value="<?= isset($_SESSION['old_form_data']['country']) ? $_SESSION['old_form_data']['country'] : '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control <?= isset($_SESSION['form_errors']['parent_name']) ? 'is-invalid' : '' ?>"
                                                ...
                                                value="<?= isset($_SESSION['old_form_data']['parent_name']) ? $_SESSION['old_form_data']['parent_name'] : '' ?>"
                                                required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="tel" class="form-control <?= isset($_SESSION['form_errors']['parent_phone']) ? 'is-invalid' : '' ?>"
                                                ...
                                                value="<?= isset($_SESSION['old_form_data']['parent_phone']) ? $_SESSION['old_form_data']['parent_phone'] : '' ?>"
                                                required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="parent_address" name="parent_address" rows="2"><?= isset($_SESSION['old_form_data']['parent_address']) ? $_SESSION['old_form_data']['parent_address'] : '' ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="additional" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Referred_by_About" name="Referred_by_About"
                                                value="<?= isset($_SESSION['old_form_data']['Referred_by_About']) ? $_SESSION['old_form_data']['Referred_by_About'] : '' ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Admission_Accpted_by" name="Admission_Accpted_by"
                                                value="<?= isset($_SESSION['old_form_data']['Admission_Accpted_by']) ? $_SESSION['old_form_data']['Admission_Accpted_by'] : '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control <?= isset($_SESSION['form_errors']['institute_name']) ? 'is-invalid' : '' ?>"
                                                ...
                                                value="<?= isset($_SESSION['old_form_data']['institute_name']) ? $_SESSION['old_form_data']['institute_name'] : '' ?>"
                                                required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select <?= isset($_SESSION['form_errors']['status']) ? 'is-invalid' : '' ?>"
                                                ...
                                                <?php foreach ($statusOptions as $value => $label): ?>
                                                    <option value="<?= $value ?>" <?= (isset($_SESSION['old_form_data']['status'])) && $_SESSION['old_form_data']['status'] == $value ? 'selected' : '' ?>>
                                                        <?= $label ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="notes" name="notes" rows="3"><?= isset($_SESSION['old_form_data']['notes']) ? $_SESSION['old_form_data']['notes'] : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        // Copy admission code to clipboard
        document.getElementById('copyAdmissionCode').addEventListener('click', function() {
            const admissionCode = document.getElementById('Admission_code');
            admissionCode.select();
